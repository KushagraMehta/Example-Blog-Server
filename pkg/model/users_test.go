...
func TestUsers(t *testing.T) {
	t.Run("Login Method", func(t *testing.T) {
	...
	t.Run("PutNewPassword Method", func(t *testing.T) {
	...
	t.Run("GetLikedPost Method", func(t *testing.T) {
	...
	t.Run("PatchLike Method", func(t *testing.T) {
	...
	t.Run("FindUserByID Method", func(t *testing.T) {
		randomUser := createRandomUser(t)
