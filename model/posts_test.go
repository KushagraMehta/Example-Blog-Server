...
func TestPost(t *testing.T) {
	...
	t.Run("Post Create Method", func(t *testing.T) {
	...
	t.Run("PatchDrafted Method", func(t *testing.T) {
		randomUser := createRandomUser(t)
		randomPost := createRandomPost(t, randomUser)
	...
	t.Run("GetPostbyID Method", func(t *testing.T) {
	...
	t.Run("GetTopPostIDs Method", func(t *testing.T) {
